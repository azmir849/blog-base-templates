...
class PostController extends Controller
{
    ...
    //             'preview_image_1' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_2' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_3' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_4' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_5' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_6' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_7' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_8' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_9' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_10' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_11' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'preview_image_12' => ['nullable', 'file', 'mimes:jpg,jpeg,png'],
    //             'gif_file' => ['nullable', 'file', 'mimes:gif'],
    //         ]);
    ...
    //         // Handling fields
    //         $filename = $this->handleFileUpload($request, 'image');
    //         $preview_images = [];
    //         $preview_titles = [];

    //         for ($i = 1; $i <= 12; $i++) {
    //             $preview_images["preview_image_$i"] = $this->handleFileUpload($request, "preview_image_$i");
    //             $preview_titles["preview_title_$i"] = $request->input("preview_title_$i", $defaultPreviewTitle);
    //         }

    //         // Key Features (use the null coalescing operator for default values)
    //         $key_features = [];
    //         for ($i = 1; $i <= 8; $i++) {
    //             $key_features["key_f_$i"] = $request->input("key_f_$i", "null");
    //         }

    //         // Handle GIF File
    //         $gif_file = $this->handleFileUpload($request, 'gif_file');

    //         // Category and Author Information
    //         $category = Category::find($request->cat_id);
    //         if ($category) {
    //             $category->increment('count_posts');
    //         }

    //         $authorName = $request->input('author_name', 'null');
    //         $authorUrl = $request->input('author_url', 'null');
    //         $otherValue = $request->input('others', 'null');
    ...
    //             'others' => $otherValue,
    //             'views' => 0,
    //             // Assign preview titles and images dynamically
    //             ...$preview_images,
    //             ...$preview_titles,
    //             ...$key_features,
    //         ]);
    ...
    // private function handleFileUpload(Request $request, $fileField)
    // {
    //     return $request->hasFile($fileField) ? $request->file($fileField)->store('posts', 'public') : null;
    // }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($validation->fails()) {
                ...
                if ($request->file_url) {
                    $posts->file_url = $request->file_url;
                }
                if ($request->preview_url) {
                    $posts->preview_url = $request->preview_url;
                }
